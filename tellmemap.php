...
<?php
	...
	if(!isset($_COOKIE['map_hour']) or $_COOKIE['map_hour'] == ""){
		...
		<p>起始日: <input type="input" name="map_day" value="'.$day.'" class="input_font" id="c" onkeyup="copyc()"></input> 查找到日: <input type="input" name="map_day2" value="'.$day.'" class="input_font" id="f" onkeyup="copyf()"></input></p>
		...
		<p>起始日: <input type="input" name="map_day" value="'.$_COOKIE['map_day'].'" class="input_font" id="c" onkeyup="copyc()"></input> 查找到日: <input type="input" name="map_day2" value="'.$_COOKIE['map_day2'].'" class="input_font" id="f" onkeyup="copyf()"></input></p>
